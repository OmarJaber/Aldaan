...
class SalesInvoice(SellingController):
    ...
    def refresh_in_words_arabic(self):
        if self.rounded_total:
            ...
            total_arabic_words = str(num2words(int(self.rounded_total),lang='ar'))
            total_arabic_words = total_arabic_words.replace('،',' و ')
            self.in_words_arabic = total_arabic_words.replace('مئة','مائة')
